package jugistanbul.paymentservice.kafka.consumer;
...
public class ValidationEventConsumer
{
    ...
    private ValidationEventConsumer() {}
    ...
    public static Consumer<Integer, EventObject> build() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "validationEventConsumerGroup02");
        ...
        consumer.subscribe(Collections.singletonList("VALIDATION_EVENT_TOPIC"));
        return consumer;
    }
}
